  ...
  return (
    <header className="bg-blue-600 dark:bg-gray-900 text-white dark:text-gray-100 p-4 shadow-lg flex justify-between items-center relative">
      ...
      <button
        ...
        className="absolute top-4 right-4 bg-gray-800 dark:bg-gray-200 text-white dark:text-gray-800 px-4 py-2 rounded-lg shadow-md hover:bg-gray-700 dark:hover:bg-gray-300 transition"
      >
